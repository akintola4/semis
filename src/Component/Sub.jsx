...
export default function Sub() {
    return (
        ...
        //     </div>
        // </section>
        <section className="relative p-6 mx-5 xl:p-22 xl:mx-32  rounded-2xl  "  data-aos="zoom-in" >
            <img
                src="img/sub.svg"
            ...
            <div className="relative ">
                <div className="flex flex-col items-center justify-between gap-4 md:gap-6 xl:p-12">
                    <div className="flex flex-col gap-2 md:gap-4 items-center text-center md:w-10/12">
                        <h4 className=" text-lg md:text-5xl md:font-extrabold   "><span className="text-primaryColor">Semis consult & and co </span>is here to help your business scale into success</h4>
